...
class PhotosAndReviewsContainer extends Component {
	constructor() {
		super();
		this.state = {
			concertDetails: null,
	...
	_fetchConcertDetails(id) {
		var query = QUERY_URL.replace('concert_id', this.props.concert_id);
		fetch(query)
			...
			<View style={styles.container}>
				...
				</View>
				{
					this.state.view === viewConstants.photos ? 
						<Photos concertId={this.props.concert_id} /> :
						<Reviews concertId={this.props.concert_id} 
...
module.exports = PhotosAndReviewsContainer;
